...
namespace Subtegral.DialogueSystem.Editor
{
    public class StoryGraphView : GraphView
    {
        ...
        public DialogueNode CreateNode(string nodeName, Vector2 position)
        {
            ...
            tempDialogueNode.Add(new ResizableElement());
        ...
        public void CreateNewTweetNode(string nodeName, Vector2 position)
        {
            AddElement(CreateTweetNode(nodeName, position));
        }
        public TweetNode CreateTweetNode(string name, Vector2 position)
        {
            ...
            tweetNode.styleSheets.Add(Resources.Load<StyleSheet>("Node"));
            var inputPort = GetPortInstance(tweetNode, Direction.Input, Port.Capacity.Multi);
            inputPort.portName = "Input";
            tweetNode.inputContainer.Add(inputPort);
            tweetNode.RefreshExpandedState();
            tweetNode.RefreshPorts();
            tweetNode.SetPosition(new Rect(position,
                DefaultNodeSize)); //To-Do: implement screen center instantiation positioning
            ...
            var button = new Button(() => { AddChoicePort(tweetNode); })
            {
                name = "Choice Button",
                text = "Add Choice"
            };
            tweetNode.titleButtonContainer.Add(button);
